    ...
    def _get_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                ...
                "is_active": {
                    "type": "boolean",
                    "description": "Активно ли объявление. False если на странице есть текст 'Объявление снято с публикации', 'Объявление недоступно', 'снято с продажи' или аналогичный. True если объявление активно."
                },
                "price_history": {
                    "type": "array",
